    ...
    <div className="bg-foreground text-background text-xs w-full">
      <div className="mx-auto max-w-6xl px-4 h-12 flex items-center justify-between">
        <div className="flex items-center gap-5">
          <a href="tel:+913340325000" className="inline-flex items-center gap-2 hover:opacity-90 ml-8">
            <PhoneCall className="size-4" aria-hidden />
            <span>+91 3340325000</span>
          </a>
          <a href="mailto:balmukundsponge@gmail.com" className="inline-flex items-center gap-2 hover:opacity-90 ml-10">
